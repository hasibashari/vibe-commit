...
export const VibeEnvironment: React.FC<VibeEnvironmentProps> = ({ 
  ...
  return (
    <div className={`fixed inset-0 z-[-1] pointer-events-none overflow-hidden transition-colors duration-[2000ms] ${theme.bg}`}>
      ...
      {/* 1. Cinematic RPG Background Image dengan Parallax */}
      <motion.div 
        ...
        style={{
          ...
          x: parallaxX,
          y: parallaxY,
          scale: 1.02 // Mencegah batas tepi terlihat selama parallax
        }}
      />

      {/* 2. Atmosphere & Readability Overlays */}
      <div className={`absolute inset-0 bg-linear-to-b transition-all duration-[2000ms] ease-in-out ${

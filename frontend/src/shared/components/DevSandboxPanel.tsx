...
export const DevSandboxPanel: React.FC<DevSandboxPanelProps> = ({
  overrides,
  setOverrides,
  user,
  sandboxAction,
              ...
              <div className='space-y-4'>
                ...
                <div className='space-y-2'>
                  ...
                  <div className='flex items-center gap-2'>
                    ...
                    />
                    <button
                      onClick={() => sandboxAction({ hp: 100 })}
                      className='text-[10px] text-fuchsia-400 px-2 py-1 bg-fuchsia-400/10 rounded'
                    >
                      Max
                    </button>
                  </div>
                ...
                <div className='space-y-2'>
                  ...
                  <div className='flex items-center gap-2'>
                    ...
                    />
                    <button
                      onClick={() => sandboxAction({ mana: 100 })}
                      className='text-[10px] text-fuchsia-400 px-2 py-1 bg-fuchsia-400/10 rounded'
                    >
                      Max
                    </button>
                ...
                <div className='space-y-2'>
                  ...
                  <div className='flex gap-2'>
                    <button
                      onClick={() => sandboxAction({ coins_delta: 100 })}
                      className='flex-1 text-[10px] py-1.5 bg-slate-800 rounded border border-slate-700 hover:bg-slate-700 text-slate-200 flex items-center justify-center gap-1'
                    >
                      <Coins className='w-3 h-3' /> +100
                    </button>
                    <button
                      onClick={() => sandboxAction({ coins_delta: 1000 })}
                      className='flex-1 text-[10px] py-1.5 bg-slate-800 rounded border border-slate-700 hover:bg-slate-700 text-slate-200 flex items-center justify-center gap-1'
                    >
                      <Coins className='w-3 h-3' /> +1000
                    </button>
                  </div>
                </div>
                ...
                <div className='space-y-2'>
                  ...
                  <div className='flex gap-2'>
                    <button
                      onClick={() => sandboxAction({ level: 1 })}
                      className='flex-1 text-[10px] py-1.5 bg-slate-800 rounded border border-slate-700 hover:bg-slate-700 text-slate-200'
                    >
                      Level 1
                    </button>
                    <button
                      onClick={() => sandboxAction({ level: 10 })}
                      className='flex-1 text-[10px] py-1.5 bg-slate-800 rounded border border-slate-700 hover:bg-slate-700 text-slate-200'
                    >
                      Level 10
                    </button>
              ...
              <div className='space-y-4'>
                ...
                <div className='space-y-2'>
                  <div className='flex justify-between text-xs text-slate-300'>
                    ...
                    <span>
                      {overrides.anxietyScore !== null ? overrides.anxietyScore : 'Default'}
                    </span>
                  </div>
                  <div className='flex items-center gap-2'>
                    <input
                    ...
                    />
                    <button
                      onClick={() => updateOverride('anxietyScore', null)}
                      className='text-[10px] text-fuchsia-400 px-2 py-1 bg-fuchsia-400/10 rounded'
                    >
                      Reset
                    </button>
                ...
                <div className='space-y-2'>
                  <div className='flex justify-between text-xs text-slate-300'>
                    <span>Sigma/Fog</span>
                    <span>
                      {overrides.sigmaVariance !== null
                        ? overrides.sigmaVariance.toFixed(1)
                        : 'Default'}
                    </span>
                  </div>
                  <div className='flex items-center gap-2'>
                    ...
                    />
                    <button
                      onClick={() => updateOverride('sigmaVariance', null)}
                      className='text-[10px] text-fuchsia-400 px-2 py-1 bg-fuchsia-400/10 rounded'
                    >
                      Reset
                    </button>

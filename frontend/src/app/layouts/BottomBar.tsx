  ...
  return (
    <div className="md:hidden fixed bottom-4 sm:bottom-6 left-1/2 -translate-x-1/2 w-[calc(100%-1rem)] sm:w-[calc(100%-2rem)] max-w-md z-[100] pb-[env(safe-area-inset-bottom)]">
      <div className="flex justify-around items-center h-14 sm:h-16 px-1 bg-slate-950/90 backdrop-blur-2xl border border-slate-700/50 shadow-[0_10px_40px_rgba(0,0,0,0.8),inset_0_1px_rgba(255,255,255,0.1)] rounded-xl sm:rounded-2xl relative">
        ...
        <Button variant="ghost" onClick={() => setActiveTab('character')} className="!p-0 !bg-transparent hover:!bg-transparent flex flex-col items-center justify-center w-[18%] !h-full gap-1 group relative rounded-none">
          ...
          <span className={`text-[10px] sm:text-xs font-bold uppercase tracking-widest transition-all duration-300 absolute bottom-1 ${activeTab === 'character' ? 'opacity-100 text-rose-300' : 'opacity-0 text-slate-500'}`}>Status</span>
        </Button>
        ...
        <Button variant="ghost" onClick={() => setActiveTab('quests')} className="!p-0 !bg-transparent hover:!bg-transparent flex flex-col items-center justify-center w-[18%] !h-full gap-1 group relative rounded-none">
          ...
          <span className={`text-[10px] sm:text-xs font-bold uppercase tracking-widest transition-all duration-300 absolute bottom-1 ${activeTab === 'quests' ? 'opacity-100 text-indigo-300' : 'opacity-0 text-slate-500'}`}>Quest</span>
        </Button>

        <Button variant="ghost" onClick={onNewQuest} className="!p-0 !bg-transparent hover:!bg-transparent flex flex-col items-center justify-center w-[18%] !h-full gap-1 group relative pb-[2px] rounded-none">
          ...
          <span className="text-[10px] sm:text-xs font-bold uppercase tracking-widest transition-all duration-300 absolute bottom-1 opacity-0 text-slate-500 group-hover:text-purple-300 group-hover:opacity-100">New</span>
        </Button>

                  ...
                  {achievements.map((ach) => (
                    ...
                    >
                      <div className={cn(
                        ...
                        ach.isUnlocked ? "bg-gradient-to-br from-indigo-500 to-accent-500 text-white" : "bg-slate-800 text-slate-500"
                      )}>
                        {getIcon(ach.icon)}
                      </div>
            ...
            >
              ...
              <div className="grid grid-cols-1 gap-3">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 p-4 rounded-xl border bg-slate-900 border-slate-800 hover:border-accent-500/30 transition-colors group">
                  <div className="w-12 h-12 shrink-0 rounded-full flex items-center justify-center shadow-inner bg-gradient-to-br from-accent-500/20 to-accent-500/5 text-accent-400 group-hover:scale-110 transition-transform">

...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} preventBackdropClose={isResetConfirm}>
      ...
      <div className='p-4 sm:p-6 flex flex-col gap-6'>
        ...
        <div className='flex flex-col gap-3 pt-6 border-t border-white/5'>
          ...
          <div className='flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-slate-900 border border-slate-800 p-3 rounded-xl mb-2'>
            ...
            >
              ...
              <option
                value='neon'
                disabled={
                  !(user.unlocked_items && user.unlocked_items.includes('aesthetic_theme_neon'))
                }
              >
                Neon City{' '}
                {!(user.unlocked_items && user.unlocked_items.includes('aesthetic_theme_neon')) &&
              ...
              <option
                value='matrix'
                disabled={
                  !(user.unlocked_items && user.unlocked_items.includes('aesthetic_theme_matrix'))
                }
              >
                Matrix Green{' '}
                {!(user.unlocked_items && user.unlocked_items.includes('aesthetic_theme_matrix')) &&
          ...
          <div className='grid grid-cols-1 gap-3'>
            {[
              ...
              <div
                key={item.id}
                className='flex items-center justify-between bg-slate-900 border border-slate-800 p-3 rounded-xl'
              >
                <div className='flex flex-col'>
                ...
                <div className='flex gap-2 items-center'>
                  ...
                  <div className='relative'>
                    ...
                    <Button
                      variant='secondary'
                      className='px-3 py-1.5 h-auto text-xs gap-1 pointer-events-none'
                      disabled={isUploading}
                    >
        ...
        <div className='flex flex-col gap-4 pt-6 border-t border-white/5'>
          ...
          <Button variant='secondary' onClick={onExport} className='w-full gap-2'>
          ...
          <div className='relative w-full'>
            ...
            />
            <Button variant='secondary' className='w-full gap-2 pointer-events-none'>
          ...
          {!isResetConfirm ? (
            ...
            <div className='bg-rose-500/10 border border-rose-500/30 rounded-xl p-4 flex flex-col gap-4'>
              <div className='flex items-start gap-3 text-rose-400 text-sm'>
                ...
                <p>
                  This will permanently erase all your quests, logs, exp, and stats. This cannot be
                  undone.
                </p>
              </div>
          ...
          {!isDeleteConfirm ? (
            ...
            <div className='bg-rose-500/10 border border-rose-500/30 rounded-xl p-4 flex flex-col gap-4'>
              <div className='flex items-start gap-3 text-rose-400 text-sm'>
                <TriangleAlert className='w-5 h-5 shrink-0 mt-0.5' />
                <p>
                  WARNING: This will permanently delete your account, authentication credentials,
                  active quests, completion logs, and cached statistics both locally and on the

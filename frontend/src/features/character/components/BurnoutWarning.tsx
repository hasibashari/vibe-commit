  ...
  return (
    ...
    >
      ...
      <div className='mt-2 space-y-2'>
        <h4 className='text-xs text-rose-400 font-bold uppercase tracking-widest'>
          Wajib Side-Quest Recovery:
        </h4>
        {burnoutMonitor.sideQuests?.map((sq, i) => (
          <div
            key={i}
            className='bg-rose-900/10 border border-rose-500/20 p-2 rounded text-xs flex gap-2 items-start'
          >

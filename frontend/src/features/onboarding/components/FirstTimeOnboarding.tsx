  ...
  const steps = [
    {
      ...
      icon: <Zap className="w-12 h-12 text-cyan-400 mb-4 drop-shadow-[0_0_15px_rgba(34,211,238,0.6)] animate-pulse" />,
      highlight: "RPG"
    },
    {
    ...
    },
    {
      ...
      icon: <Cpu className="w-12 h-12 text-indigo-400 mb-4 drop-shadow-[0_0_15px_rgba(129,140,248,0.6)]" />,
      highlight: "offline"
    }
  ];

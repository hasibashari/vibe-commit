...
export const LifeCommitHeatmap: React.FC<HeatmapProps> = ({ logs }) => {
  ...
  const getColor = (count: number) => {
    ...
    if (count === 1) return 'bg-emerald-900 border border-emerald-800/50 shadow-[0_0_8px_rgba(6,78,59,0.3)]';
    if (count === 2) return 'bg-emerald-700 border border-emerald-600/50 shadow-[0_0_10px_rgba(4,120,87,0.4)]';
    if (count === 3) return 'bg-emerald-500 border border-emerald-400/50 shadow-[0_0_12px_rgba(16,185,129,0.5)]';
